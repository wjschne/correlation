...
includes a set of variables depicted as circles ("nodes") and a set of lines
...
It also provides some cutting-edge methods, such as Multilevel (partial)
correlations. These are partial correlations based on linear mixed-effects
models that include the factors as **random effects**. They can be seen as
